...
def p3():
    ...
    print("Error ~10^-4")
    print(
        "I would suggest using the fastest method(Trapazoidal) because the error caused by the data will always be greater than the error caused by any of the integration methods"
    )
